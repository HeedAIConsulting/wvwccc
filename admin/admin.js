...
window.Admin = (function () {
  ...
  const HELP = [
    ...
    { id: 'member-by-category', t: 'Get a list of just one kind of business (restaurants, salons…)', kw: 'category list restaurants restaurant salon retail filter search just only type of business invite email group mailing list directory of', href: 'members.html', sel: '#memberSearch', tip: 'Type the category in the search box — “restaurant” — then click ⬇ Export CSV. The file holds exactly the members on screen, with their emails, ready to paste into a BCC.' },
  ...
  async function initEvents() {
    ...
    // Shared with the member event form — see js/rich-editor.js.
