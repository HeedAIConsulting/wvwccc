...
brand_font = ImageFont.truetype(FDIR + "LiberationSans-Bold.ttf", 34)
...
def render(f):
    ...
    # brand footer, centered, present on every frame
    bw = measurer.textlength(BRAND, font=brand_font)
    d.text(((W - bw) / 2, H - 96), BRAND, font=brand_font, fill=GOLD)
